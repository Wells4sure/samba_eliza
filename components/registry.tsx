      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <Card className="text-center border-amber-300 shadow-md hover:shadow-lg transition-shadow">
            ...
            <CardContent>
              <p className="text-gray-700 mb-4">Kitchen essentials and home goods</p>
          ...
          <Card className="text-center border-amber-300 shadow-md hover:shadow-lg transition-shadow">
            ...
            <CardContent>
              <p className="text-gray-700 mb-4">Furniture and home decor</p>
              <Button variant="outline" className="border-amber-400 text-amber-700 hover:bg-amber-50">
                View Registry <ExternalLink className="w-4 h-4 ml-2" />
              </Button>
            </CardContent>
          ...
          <Card className="text-center border-amber-300 shadow-md hover:shadow-lg transition-shadow">
            ...
            <CardContent>
              <p className="text-gray-700 mb-4">Help us explore Italy together</p>
              <Button variant="outline" className="border-amber-400 text-amber-700 hover:bg-amber-50">
